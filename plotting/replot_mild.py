#!/usr/bin/env python
"""Plot K=10 mild erasure results — 3-subplot (M=4, 20, 40)."""
import sys, os
...
# Load mild results
with open(os.path.join(RESULTS_DIR, 'k10_mild_results.pkl'), 'rb') as f:
    saved = pickle.load(f)
...
fig.tight_layout()
fig_path = os.path.join(RESULTS_DIR, 'k10_mild_jsait.png')
